...
export const myths = [
  {
    ...
    reality: "Renting can outperform buying in high-cost markets. Flexibility has financial value too.",
    verdict: "It depends",
    color: "#F59E0B",
  },
  {
    myth: "You need to earn more to build wealth",
    reality: "How you spend matters more than how much you earn. A $50k saver can outperform a $150k spender.",
    verdict: "False",
    color: "#EF4444",
  },
  {
    myth: "A good credit score means you're good with money",
    reality: "A credit score measures how reliably you use debt — not your actual wealth or savings rate.",
    verdict: "Misleading",
    color: "#F59E0B",
  },
  {
    myth: "Investing is too risky for young people",
    reality: "Time horizon is your greatest asset. At 22, a market crash is an opportunity, not a threat.",
    verdict: "False",
    color: "#EF4444",
  },
  {
    myth: "I'll start saving when I make more",
    reality: "Lifestyle inflation will absorb every raise. The habit must come before the higher income.",
    verdict: "A trap",
    color: "#EF4444",
  },
  {
    myth: "Having a budget means you can't enjoy life",
    reality: "A budget is permission to spend — guilt-free — on what you actually value.",
    verdict: "False",
    color: "#EF4444",
  },
];
    ...
    choices: [
      {
        ...
        impact: -12800,
        mood: "danger",
        lesson: "That $450/mo compounds against you. At 7% APR over 5 years, you pay $2,800 in interest alone.",
      },
      {
        ...
        impact: 18400,
        mood: "success",
        lesson: "Investing $200/mo at 7% for 10 years = $34,000. You turned a boring decision into financial freedom.",
      },
      {
        ...
        impact: -19800,
        mood: "danger",
        lesson: "After 3 years you own nothing and paid $19,800. Leasing transfers wealth from you to the dealership.",
      },
    ],
  },
  {
    ...
    context: "Life happened. Emergency, a trip, whatever. You owe $3,000 at 22% APR.",
    choices: [
      {
        ...
        impact: -2340,
        mood: "danger",
        lesson: "At minimum payments, $3,000 at 22% APR takes 9 years and costs $2,340 extra in interest.",
      },
      {
        ...
        impact: 1800,
        mood: "success",
        lesson: "Paying $300/mo clears the debt in 11 months and saves $1,800 in interest.",
      },
      {
        ...
        impact: 1200,
        mood: "success",
        lesson: "A 0% balance transfer buys you 15 months interest-free. Every dollar goes to principal.",
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        impact: -89000,
        mood: "danger",
        lesson: "Not contributing is a 100% instant loss. Over 20 years at 7%, that's $133,000 you walked away from.",
      },
      {
        label: "Match only (5%)",
        icon: "✅",
        ...
        impact: 89000,
        mood: "success",
        lesson: "Capturing the full match means $6,500/yr invested. That's a 100% instant return.",
      },
      {
        label: "Max it out (15%)",
        icon: "🚀",
        ...
        impact: 267000,
        mood: "success",
        lesson: "Contributing 15% + match = $13,000/yr invested. At 7% for 20 years: $535,000.",
      },
    ],
  },
];